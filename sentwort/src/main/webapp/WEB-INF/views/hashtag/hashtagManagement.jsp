...
<html>
    ...
    <body>
						...
						<table>
							<tr>
								<td>
									...
									<kendo:button name="textButton" type="button" click="onClickAdd">
							...
							<tr>
								<td>
									<kendo:grid name="gridHashtag" groupable="true" selectable="single" sortable="true"
									 	style="height:650px;">
							...
							<tr>
								<td style="text-align:right">
									<kendo:button name="btnStart" type="button" click="onClickStart">
									    <kendo:button-content>
									        Start Listening
									    </kendo:button-content>
									</kendo:button>
									<kendo:button name="btnStop" type="button" click="onClickStop">
									    <kendo:button-content>
									        Stop Listening
									    </kendo:button-content>
									</kendo:button>
        ...
        <tr data-uid="#: id #">
			...
			<td class="details">
               <span class="description">#: isactive#</span>
            </td>
			<td class="details">
               <span class="description">#: createdate# </span>
            </td>
			<td class="details">
               <span class="description">#: startdate# </span>
            </td>
			<td class="details">
               <span class="description">#: stopdate# </span>
            </td>
        </tr>
    	</script>
		<script>
